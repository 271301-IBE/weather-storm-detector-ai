...
class DatabaseOptimizer:
    ...
    def create_indexes(self) -> bool:
        ...
        indexes = [
            ...
            "CREATE INDEX IF NOT EXISTS idx_cache_location ON weather_condition_cache(location)",
            
            # Storm patterns indexes
            "CREATE INDEX IF NOT EXISTS idx_patterns_timestamp ON storm_patterns(timestamp)",
            "CREATE INDEX IF NOT EXISTS idx_patterns_pattern ON storm_patterns(pattern_type)",
